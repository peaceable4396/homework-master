...
public class C3p0Demo {
    public static void main(String[] args) {
        ...
        try {
            ...
            updateMethod(statement, "update fruit set name = '111' where id = 1001");
            deletMethod(statement, "delete from fruit where id = 1002");
    ...
    private static void insertMethod(Statement statement) throws SQLException {
        updateMethod(statement, "insert into fruit values (1005,'西瓜','watermelon');");
    }
}
